    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Blocks", x => new { x.BlockerAccountId, x.BlockedAccountId });
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Follows", x => new { x.FollowerAccountId, x.FolloweeAccountId });
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SubjectAccountId = table.Column<Guid>(type: "uuid", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    Id = table.Column<Guid>(type: "uuid", nullable: false),
                    App = table.Column<string>(type: "character varying(64)", maxLength: 64, nullable: false),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Activities_AccountId_CreatedAt",
                table: "Activities",
                columns: new[] { "AccountId", "CreatedAt" });

            migrationBuilder.CreateIndex(
                name: "IX_Badges_AccountId_Code",
                table: "Badges",
                columns: new[] { "AccountId", "Code" },
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_Devices_AccountId_Serial",
                table: "Devices",
                columns: new[] { "AccountId", "Serial" });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_UpdateReleases_App_Channel_PublishedAt",
                table: "UpdateReleases",
                columns: new[] { "App", "Channel", "PublishedAt" });
        }
